...
public class InvalidArguments extends RuntimeException {
	public InvalidArguments(int reqArguments) {
		super("Invalid number of arguments. '" + reqArguments
				+ "' arguments required.");
	}

	public InvalidArguments(int argNo, Class type) {
		super("'" + type.getName() + "' is an invalid argument type for '"
				+ argNo + "'.");
	}
}